"""
Some old approaches to regridding (actually, downgridding) which were initially
designed to be used in `Cont.from_rv()`.
"""
import numpy as np
...
print(f"{dist_grid((x, y), (x_equi, y_equi), method='maxabs')=}")
print(f"{dist_grid((x, y), (x_curv, y_curv), method='maxabs')=}")
print(f"{dist_grid((x, y), (x_quant, y_quant), method='maxabs')=}")
print(f"{dist_grid((x, y), (x_optim, y_optim), method='maxabs')=}")

print(f"{dist_grid((x, y), (x_equi, y_equi), method='meanabs')=}")
print(f"{dist_grid((x, y), (x_curv, y_curv), method='meanabs')=}")
print(f"{dist_grid((x, y), (x_quant, y_quant), method='meanabs')=}")
print(f"{dist_grid((x, y), (x_optim, y_optim), method='meanabs')=}")
